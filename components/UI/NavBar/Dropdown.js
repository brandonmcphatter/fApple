...
export default function Dropdown({toggleMenu}) {
    ...
    return (
        <div className={'w-svw h-svh pt-3 animate__animated animate__slideInDown'} style={{backgroundColor: '#161617'}}>
            {/*Display Area*/}
...
function AllProducts({iPhoneView, toggleMenu}) {
    return (
        <div className={'animate__animated animate__fadeIn animate__delay'}>
            ...
            {/*List of options*/}
            <div className={'ps-10  text-2xl tracking-wide animate__animated animate__slideInLeft'} style={{fontFamily: 'Helvetica', color: '#e8e8ed'}}>
                <ul className={'grid'}>
                    <DropItem name={'Store'}/>
                    <DropItem name={'Mac'}/>
                    <DropItem name={'iPad'}/>
                    <div className={'animate__animated animate__pulse animate__delay-1s'} onClick={iPhoneView}><DropItem name={'iPhone'}/></div>
                    <DropItem name={'Watch'}/>
            ...
            <div className={'ps-10 pb-24 text-2xl tracking-wide'} style={{fontFamily: 'Helvetica', color: '#e8e8ed'}}>
                <ul className={'grid'}>
                    ...
                    <Link onClick={toggleMenu} href={'/iphone-16-pro'}>
                        <div className={'animate__animated animate__pulse delay-1s'}><DropItem name={'iPhone 16 Pro'}/></div>
                    </Link>
